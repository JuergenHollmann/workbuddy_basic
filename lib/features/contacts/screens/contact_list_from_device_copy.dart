...
class _ContactListFromDeviceState extends State<ContactListFromDevice>
  ...
  Future<void> loadInitialContacts() async {
    ...
    if (await FlutterContacts.requestPermission()) {
      ...
      // Die ersten zehn Kontakte ohne zusätzliche Details laden
  ...
  Future<void> loadAllContacts() async {
    ...
    await Future.delayed(Duration(seconds: 2)); // Mindestens 2 Sekunden warten
              ...
              child: Column(
                ...
                children: [
                  RotationTransition(
                    ...
                    child: Image.asset(
                      'assets/images/workbuddy_logo.png', // Pfad zum WorkBuddy-Logo
                      width: 100,
                      height: 100,
                    ),
                  ),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Container(
                            ...
                            child: Card(
                              color:
                                  wbColorBackgroundBlue, // Card blau einfärben
