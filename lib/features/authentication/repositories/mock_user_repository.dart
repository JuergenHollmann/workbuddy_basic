...
class MockUserRepository implements UserRepository {
  ...
  Future<ServerUserResponse> loginAndGetUser(
    ...
    if (email.endsWith("@test.de")) {
      ...
      if (password == "123") {
        /* Wenn der Nutzer sich mit einer normalen E-Mail angemeldet hat, geben wir den normalen User zurück. */
      ...
      /* Die E-Mail, mit der sich der Nutzer angemeldet hat, existiert gar nicht in unserer fiktiven Datenbank, und wir geben eine fehlgeschlagene ServerUserResponse zurück. */
