...
class UserService {
  ...
  /* Unser MockUserRepository, das die Abfrage eines Nutzers simuliert, sobald wir uns einloggen. Hier könnte man die Abfrage des Nutzers und das Einloggen in zwei Repositories/Module aufteilen. */
  final _mockUserRepository = MockUserRepository();

  /* Hier werden die E-Mail und das Passwort abgerufen, und die "login"-Methode im mockUserRepository ausgeführt. */
